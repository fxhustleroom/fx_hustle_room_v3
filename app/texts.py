...
TEXTS = {
    ...
    "welcome": {
        "en": "The FX Hustle Room Premium Signals ➡️ The FX Hustle Room Exclusive Trading Alerts",
        "es": "FX Hustle Room Señales Premium ➡️ Alertas de Trading Exclusivas de FX Hustle Room",
        "fr": "FX Hustle Room Signaux Premium ➡️ Alertes de Trading Exclusives de FX Hustle Room",
        "de": "FX Hustle Room Premium Signale ➡️ Exklusive Trading-Alerts von FX Hustle Room",
        "pt": "FX Hustle Room Sinais Premium ➡️ Alertas de Trading Exclusivos da FX Hustle Room",
        "ar": "إشارات FX Hustle Room المميزة ➡️ تنبيهات التداول الحصرية من FX Hustle Room",
        "hi": "FX Hustle Room प्रीमियम सिग्नल्स ➡️ FX Hustle Room एक्सक्लूसिव ट्रेडिंग अलर्ट्स",
        "id": "Sinyal Premium FX Hustle Room ➡️ Peringatan Trading Eksklusif FX Hustle Room",
        "tr": "FX Hustle Room Premium Sinyalleri ➡️ FX Hustle Room Özel Trading Uyarıları",
        "ru": "Премиум сигналы FX Hustle Room ➡️ Эксклюзивные торговые оповещения FX Hustle Room",
    },
    "terms": {
